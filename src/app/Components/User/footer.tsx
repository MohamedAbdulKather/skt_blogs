...
const Footer = () => {
  return (
    <footer className="w-full bg-black text-white">
      {/* Enhanced Banner Image with Shadow Border */}
      <div className="relative w-full overflow-hidden">
        {/* White shadow at the top - creates a bright highlight effect */}
        <div className="absolute top-0 left-0 right-0 h-30 z-100
          bg-gradient-to-b from-white to-transparent pointer-events-none"></div>
        
        {/* Inner shadow overlay - fading from bottom */}
        <div className="absolute inset-0 shadow-inner z-0
          bg-gradient-to-t from-black via-transparent pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex flex-wrap justify-between relative">
        {/* Main Links Column - full width on mobile, then 1/3 */}
        ...
        <div className="w-full md:w-1/3 mb-8 md:mb-0">
          ...
          ஒருவரின் அனுபவம் மற்றவருக்கு ஒளி. சித்தை துளிகள் வழியாக கல்வி, சமூகம், சிந்தனைகள், நல்லிணக்கம், ஊக்கம், அனுபவங்கள் மற்றும் வாழ்க்கைப் பாடங்களை பகிர்ந்துகொள்வோம்.
          </p>
        </div>
        
        {/* Social Links Column - full width on mobile, then 1/3 */}
        <div className="w-full md:w-1/3 md:text-center">
          <h3 className="text-lg font-semibold mb-4 sm:mb-6 text-orange-400">Follow Us</h3>
